...
export default function HackerOverlay({ jobId, onComplete }: HackerOverlayProps) {
    ...
    eventSource.onmessage = (event) => {
      try {
        ...
        if (data.type === 'done' || data.type === 'complete') {
          eventSource.close();
          // Eliminado setTimeout(onComplete) para obligar al cierre manual
        }
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-[#161b22] px-4 py-3 flex items-center border-b border-gray-800">
